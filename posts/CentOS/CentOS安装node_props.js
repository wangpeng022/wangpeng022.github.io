...
export default {
    ...
    'outputPath': "posts/CentOS/CentOS安装node.html",
    'title': "CentOS安装node",
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h3 id="%E5%AE%89%E8%A3%85%E6%AD%A5%E9%AA%A4">安装步骤：<a class="anchor" href="#%E5%AE%89%E8%A3%85%E6%AD%A5%E9%AA%A4">§</a></h3>\n<ol>\n<li>去node官网复制下载链接（下载相应的LTS版本）；</li>\n<li>开始下载安装包；</li>\n</ol>\n<pre class="language-autoit"><code class="language-autoit">wget https<span class="token punctuation">:</span><span class="token operator">/</span><span class="token operator">/</span>npm<span class="token punctuation">.</span>taobao<span class="token punctuation">.</span>org<span class="token operator">/</span>mirrors<span class="token operator">/</span>node<span class="token operator">/</span>v14<span class="token punctuation">.</span><span class="token number">18.1</span><span class="token operator">/</span>node<span class="token operator">-</span>v14<span class="token punctuation">.</span><span class="token number">18.1</span><span class="token operator">-</span>linux<span class="token operator">-</span>x64<span class="token punctuation">.</span>tar<span class="token punctuation">.</span>xz\n\n</code></pre>\n<ol start="3">\n<li>解压</li>\n</ol>\n<pre class="language-autoit"><code class="language-autoit">tar <span class="token operator">-</span>xvf node<span class="token operator">-</span>v10<span class="token punctuation">.</span><span class="token number">15.3</span><span class="token operator">-</span>linux<span class="token operator">-</span>x64<span class="token punctuation">.</span>tar<span class="token punctuation">.</span>xz\n</code></pre>\n<ol start="4">\n<li>cd 到 node-v10.15.3-linux-x64 目录 检查是否成功。</li>\n</ol>\n<pre class="language-autoit"><code class="language-autoit">node <span class="token operator">-</span>v\n</code></pre>\n<ol start="5">\n<li>更改文件夹名称</li>\n</ol>\n<pre class="language-autoit"><code class="language-autoit">mv node<span class="token operator">-</span>v14<span class="token punctuation">.</span><span class="token number">18.1</span><span class="token operator">-</span>linux<span class="token operator">-</span>x64 node\n\n</code></pre>\n<ol start="5">\n<li>配置软连接，使全局都可以使用node命令</li>\n</ol>\n<pre class="language-autoit"><code class="language-autoit">ln <span class="token operator">-</span>s <span class="token operator">/</span>usr<span class="token operator">/</span><span class="token keyword">local</span><span class="token operator">/</span>node<span class="token operator">/</span>bin<span class="token operator">/</span>node <span class="token operator">/</span>usr<span class="token operator">/</span>bin<span class="token operator">/</span>node  <span class="token operator">-</span><span class="token operator">-</span>将node源文件映射到usr<span class="token operator">/</span>bin下的node文件\n\nln <span class="token operator">-</span>s <span class="token operator">/</span>usr<span class="token operator">/</span><span class="token keyword">local</span><span class="token operator">/</span>node<span class="token operator">/</span>bin<span class="token operator">/</span>npm <span class="token operator">/</span>usr<span class="token operator">/</span>bin<span class="token operator">/</span>npm\n</code></pre>'
        } }),
    'head': null,
